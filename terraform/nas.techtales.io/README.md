...
| Name | Version |
|------|---------|
| <a name="requirement_terraform"></a> [terraform](#requirement\_terraform) | >= 1.9.0, <= 1.14.8 |
...
| Name | Version |
|------|---------|
| <a name="provider_minio"></a> [minio](#provider\_minio) | 3.28.1 |
...
| Name | Type |
|------|------|
| [minio_s3_bucket_replication.backup](https://registry.terraform.io/providers/aminueza/minio/3.28.1/docs/resources/s3_bucket_replication) | resource |
| [minio_s3_bucket_replication.terraform](https://registry.terraform.io/providers/aminueza/minio/3.28.1/docs/resources/s3_bucket_replication) | resource |
